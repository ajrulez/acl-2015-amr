...
We improve recall over the previous state-of-the-art result for AMR parsing.
This raises end-to-end F$_1$ from 0.59 to 0.62 on the LDC2013E117 and LDC2014T12 datasets.
...
This action applies \textbf{NAME}, and in addition we attach a created \n{person} type-indicator above the created \n{name} for the span.

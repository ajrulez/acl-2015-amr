...
We evaluate on two corpora: the LDC2014T12 corpus, consisting of \todo{what?};
  and, the LDC2014E117 corpus, consisting of \todo{what?}.
...
Results on two AMR datasets for JAMR and our NER++ embedded in the JAMR SRL++
  component.
Note that recall is consistently higher across both dataasets, with only a small
  loss in precision.
}
\end{table}
...
\todo{gabor: isn't this a repeat of the CMU table?}
}
\end{table}
...
We evaluate our aligner on a small set of 100 hand-labeled alignments,
  and evaluate our NER++ classifer on these automatically generated alignments,
\todo{alignment accuracy}

On the automatic alignments over the LDC2014T12 corpus,
  our actionclassifier achieved a test accuracy of \textbf{0.841}.
...
\Subsection{errors}{Error Analysis}
\todo{gabor}
